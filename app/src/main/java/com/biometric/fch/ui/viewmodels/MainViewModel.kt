...
import com.biometric.fch.logic.network.usercases.CreateUserWithEmailAndPasswordUserCase
import com.biometric.fch.logic.network.usercases.SaveUserInDBUserCase
import com.biometric.fch.logic.network.usercases.SigInUserWithEmailAndPasswordUserCase
...
class MainViewModel: ViewModel() {
    ...
    fun sigInUserWithEmailAndPasswordNULL(email: String, password: String){
        viewModelScope.launch(Dispatchers.IO) {
            val us = SigInUserWithEmailAndPasswordUserCase().invoke(email,password)
            if (us == null){
                _user.postValue(us!!)
