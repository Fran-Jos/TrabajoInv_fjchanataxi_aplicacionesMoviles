...
import com.biometric.fch.databinding.ActivityMainBinding
import com.biometric.fch.ui.viewmodels.MainViewModel
import com.google.android.material.snackbar.Snackbar
import java.util.concurrent.Executor

class MainActivityCLASEING : AppCompatActivity() {
        ...
        biometricPrompt = BiometricPrompt(this, executor,
            object : BiometricPrompt.AuthenticationCallback() {
                override fun onAuthenticationSucceeded(result: BiometricPrompt.AuthenticationResult) {
                    ...
                    startActivity(Intent(this@MainActivityCLASEING, MainActivity2::class.java))
                }
            })
